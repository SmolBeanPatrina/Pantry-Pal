...
const Testimonials = () => {
  return (
    ...
    overflow-hidden' id='Testimonials'>
      ...
      text-center'>Customer <span className='underline underline-offset-4 decoration-1 under font-light'>Testimonials</span></h1>
      <p className='text-center text-gray-500 mb-12 max-w-80
      mx-auto'>Real Stories from Those Who Found Nutritional Benefits with Us</p>
